              ...
              {step === 1 && (
                <div className="fi">
                  ...
                  <div style={{ marginBottom: 18 }}>
                    <TLabel T={T}>髪質</TLabel>
                    <SelectGrid options={hairTextures} value={form.hairTexture} onChange={v => update("hairTexture", v)} T={T} />
                    <div style={{ fontSize: 10, color: T.subtext, lineHeight: 1.7, marginTop: 6, background: T.palest, borderRadius: 8, padding: "8px 10px", border: `1px solid ${T.rose}` }}>
                      💡 硬さ・柔らかさが普通くらいで迷う場合は、うねりやくせがなければ「直毛」、多少のうねり・くせがあれば「くせ毛」を選んでください。
                    </div>
                  </div>
